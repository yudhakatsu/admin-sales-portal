...
@section('content')
    <div class="container">
        <h2>Checkout</h2>
        <form id="transaction-form" action="{{ route('cart.update', $cart->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="info-customers d-flex flex-row justify-content-between">
                <div class="mb-3 col-5">
                    ...
                    <input type="text" class="form-control" id="customer_name" name="customer_name"
                        value="{{ $cart->customer->name ?? "-" }}" required>
                </div>

                <div class="mb-3 col-5">
                    <label for="phone-number" class="form-label">No Hp</label>
                    <input type="text" class="form-control" id="phone_number" name="phone_number"
                        value="{{ $cart->customer->phone_number }}" required>
                </div>
            </div>
            ...
            <div class="info-customers d-flex flex-row justify-content-between">
                <div class="mb-3 col-5">
                    ...
                    <input type="text" class="form-control" id="customer_address" name="customer_address"
                        value="{{ $cart->customer->address }}" required>
                </div>
